...
#site-page("posts/2025/teaching-pcp/index.html", tab-title: "Teaching Principal Component Pursuit in a computational physics class")[
  ...
  A few months back I dove into a book on making sense of complex data with simple models as a part of my research (#link("https://book-wright-ma.github.io/")[High-Dimensional Data Analysis with Low-Dimensional Models, by Wright and Ma]). I learned about and implemented #link("/projects/2024/principal-component-pursuit/")[a fun demo of Principal Component Pursuit (PCP)]. My advisor loved it! We played with feeding the algorithm different kinds of simulated data, and wondered about how we might apply such an idea to better understand 3D tomograms.
  ...
  #large-img("imgs/Principal_Component_Pursuit_page-0001.jpg", alt: "Slide 1")

  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0002.jpg", alt: "Slide 2")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0003.jpg", alt: "Slide 3")

  #html.video(
    controls: true,
    style: "width: 50%",
    src: "video/walking_decomposed.webm",
  )[
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0004.jpg", alt: "Slide 4")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0005.jpg", alt: "Slide 5")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0006.jpg", alt: "Slide 6")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0007.jpg", alt: "Slide 7")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0008.jpg", alt: "Slide 8")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0009.jpg", alt: "Slide 9")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0010.jpg", alt: "Slide 10")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0011.jpg", alt: "Slide 11")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0012.jpg", alt: "Slide 12")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0013.jpg", alt: "Slide 13")

  #html.video(
    controls: true,
    style: "width: 50%",
    src: "video/fridge_decomposed.webm",
  )[
    Your browser does not support the video tag.
  ]
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0014.jpg", alt: "Slide 14")
  ...
  #html.hr()
  #large-img("imgs/Principal_Component_Pursuit_page-0015.jpg", alt: "Slide 15")
