...
#site-page("posts/2026/online-batch-selection/index.html", tab-title: "Online Batch Selection")[
  ...
  = Conclusion
  Machine learning researchers hope to eventually attain a complete grasp on how AI works and how to reliably control its behavior, even though fully attaining that goal may take a very long time. Quantifying how training data affects model behavior throughout training---the primary objective of our online batch selection research---is a key aspect of that quest. While we cannot completely meet such lofty aims in the near future, we can make progress, and that progress will have far-reaching impact in other ways: it will help us streamline current AI training techniques and strengthen model reliability. 
