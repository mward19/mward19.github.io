...
#site-page("projects/2025/internship-3deo-processing-report/index.html", tab-title: "3DEO Processing Performance Report")[
  ...
  Also see example processing reports: #link("documents/processing_report_mapping.pdf")[Mapping Report], #link("documents/processing_report.pdf")[Single Tile Report]. (These are from the time of my internship presentation. Current reports contain further improvements)
  #html.hr()
  ...
  - #link("documents/processing_report_mapping.pdf")[Mapping Report] (long)
  - #link("documents/processing_report.pdf")[Single Tile Report] (short)
  ...
  #large-img("imgs/main-13.png")

  Each thread shows how long one Slurm job took.

  #large-img("imgs/main-14.png")
