...
#site-page("projects/2025/internship-3deo-spot-modeling/index.html", tab-title: "3DEO Illumination Spot Modeling")[
  ...
  #html.video(
    controls: true,
    style: "width: 90%",
    src: "video/hitmap_moving_average_window_100_slow.mp4",
  )[
  ...
  #html.video(
    controls: true,
    style: "width: 90%",
    src: "video/spot_movement_window_100_gaussians_1_new_gmmis_1_in_1_slow.mp4",
  )[
    Your browser does not support the video tag.
  ]
