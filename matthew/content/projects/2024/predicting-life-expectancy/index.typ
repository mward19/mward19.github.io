...
#html.div(class: "introduction")[
  This project is a #link("/assets/2024/documents/Life_Expectancy_Paper.pdf")[paper] with associated #link("/assets/2024/documents/Life_Expectancy_Paper_code.pdf")[code].
]
...
I usually manage my code with Git and GitHub, but this time I opted for a Jupyter notebook in Google Colab to avoid training the models on my system. #link("/assets/2024/documents/Life_Expectancy_Paper_code.pdf")[View the code here]. It proved challenging to export the large notebook to other formats (.pdf, .html). Troubleshooting would've been easier had I coded in a more robust way, by saving trained models and such. The time I spent wrestling with the notebook export reminded me to be more careful next time, in spite of any looming deadlines.

The #link("/assets/2024/documents/Life_Expectancy_Paper.pdf")[original paper] is a .pdf document, but for a better reading experience, I'll copy it as best I can below.
