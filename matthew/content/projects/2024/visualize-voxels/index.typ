...
#figure(
  html.img(src: "/assets/2024/video/helix_visualization.gif"),
  caption: [A helix plotted within a tomogram.]
)

I spend a lot of time working with #link("https://cryoetdataportal.czscience.com/browse-data/datasets")[cryo-electron tomograms]. They're huge, noisy, three-dimensional images that can take up gigabytes of storage apiece.

Naturally, visualizing these images is a pain&mdash;most of the options are desktop applications like #link("https://bio3d.colorado.edu/imod/")[IMOD]. #link("https://napari.org/stable/#")[napari] is marvelous, but heavier than I usually need. All the time I found myself in a Jupyter notebook working doing data analysis on tomograms and I just wanted a quick snapshot of what the volume looks like, perhaps with a couple keypoints marked. And I wanted it to be dead-simple, so that with a single function call and a few seconds I could see what sort of image I was working with. So I wrote _visualize_voxels_.
...
#figure(
  html.img(src: "/assets/2024/video/weird_tomo_3.gif")
)
...
Try playing with it #link("/assets/2024/documents/viz_vox_demo.html")[here].
