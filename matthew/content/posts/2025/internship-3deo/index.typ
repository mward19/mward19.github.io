...
- In #link("/projects/internship-3deo-pose-graph")[Internship with 3DEO&mdash;Pose Graph Optimization], I discuss the problem of merging together inconsistent pairwise alignments between point clouds to infer final alignments for a set of $n$ misaligned point clouds.
- In #link("/projects/internship-3deo-spot-modeling")[Internship with 3DEO&mdash;Illumination Spot Modeling], I highlight some challenges I faced while modeling the spot illuminated by a laser as detected by an airborne camera.
- In #link("/projects/internship-3deo-processing-report")[Internship with 3DEO&mdash;Processing Performance Report], I give a brief overview of a program I wrote to automatically generate reports on the performance of 3DEO's extensive processing pipeline.
