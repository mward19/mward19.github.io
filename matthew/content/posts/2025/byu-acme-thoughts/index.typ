...
#show: template.with(title: "Thoughts on BYU's ACME math program upon finishing core classes")
...
#picture(image("imgs/cover.jpg"))

This semester, I finished the "senior core" of BYU's #link("https://acme.byu.edu/")[Applied and Computational Mathematics Emphasis (ACME)] program. It's been an awesome journey, and since other people's thoughts on the internet were influential in leading me to join the program, I thought I'd share mine.

#html.hr()
== How I ended up in ACME
I started my journey at BYU studying electrical engineering. My second semester, I took Digital Systems (EC EN 220) and Circuit Analysis (EC EN 240). At the close of the semester, as I prepared for my final exams in a windowless room on the fourth floor of the Clyde (BYU's old engineering building), my thoughts wandered. I really enjoyed what I was learning, but the physics class I was also taking (PHSCS 123) and conversations with my astronomy major then-girlfriend (now wife) made me wish I could explore the fundamentals more. I wanted more theory, feeling that if I thoroughly understood the theory behind what I was doing, I could go farther in the long term. I wanted to learn to _learn_, afraid I was studying techniques and tools that wouldn't be relevant in the long term.
...
- I learned to _learn_, just as I'd hoped. (Admittedly, this probably happens in any intense university program.)
- Super cool curriculum developed by BYU faculty, supposedly unlike most applied math programs. See #link("https://foundations-of-applied-mathematics.github.io/")[information about textbooks and complete lab manuals] and #link("https://acme.byu.edu/textbooks-and-lab-materials")[textbooks' tables of contents].
- Faculty is very invested in the program, they're passionate about it. It's only twelve years old.
  - ACME won the #link("https://www.ams.org/news?news_id=7244")[American Mathematical Society's 2024 "Award for an Exemplary Program or Achievement in a Mathematics Department"]. Can you spot me in the picture?
...
- Applications well beyond pure mathematics. See #link("https://acme.byu.edu/concentrations-in-acme")[list of ACME concentrations].
- _Great_ food haha! These folks know how it's done. Abundant Cafe Rio and Panda Express at a ton of events.

=== What it's still working out
- "Volume 4", the program's textbook on dynamic systems, control theory, and related topics (see its #link("https://acme.byu.edu/textbooks-and-lab-materials")[outline]), still needs a lot of work.
  ...
  - I should note that Volumes 1 and 2 (the textbooks for the junior core) are superb, and have been published (#link("https://epubs.siam.org/doi/book/10.1137/1.9781611974904")[Volume 1], #link("https://epubs.siam.org/doi/book/10.1137/1.9781611976069")[Volume 2]), but the faculty is still working on volumes 3 and 4 (see #link("https://acme.byu.edu/textbooks-and-lab-materials")[textbooks' tables of contents]). Volume 3 is in great shape, I'd say. Volume 4 needs some work.
- The workload can be very intense. The pressure just about breaks _everyone_ at some point in their experience.
  - In the junior core, each homework assignment (students have six homework sets a week) took me around 3 hours, even 4 on bad days. Add on top of that the 2 or 3 hour labs assigned twice a week, and you end up pretty busy, since you're also expected to do textbook readings before each class. (Not to mention the mental strain---breaks are a _must_!)
  ...
  - The core classes technically total 8 credit hours per semester (12 credits is the minimum one has to take to keep scholarships), but took a lot more time than any other 8 credits would have. I've started telling people to schedule their semester thinking of ACME as 12 credits rather than 8, since it _will_ take over your life for two years, in a sense. I sometimes wish the number of credit hours reflected the workload, although I'm aware of some reasons that such an increase in credit hours is not possible.
- Prideful attitudes.
  - It seems like this is getting less common in the program (I hope it is at least). I noticed that students in other programs, like engineering, physics, and #link("https://apex.byu.edu/what-is-apex")[APEX Math] (BYU's more mainstream math program) sometimes harbored some resentment for the ACME program because of prideful people they'd interacted with. I remember talking to an engineering student about ACME---he told me that he knew about the program, since a peer in one of his engineering classes was in ACME, and constantly reminded everyone in the class how easy the integrals and other tricky math concepts were for him! Nobody wants to work with a person like that, and ACME's grandiose promises ("world domination" comes to mind 😉) might contribute to some students having such attitudes.
...
- Internalize the law of diminishing returns.
  - I found that I could put in 70% of the time and learn 95% of the material on homework assigments. Would that last 5% have been worth it? I don't think so. I got A's in all my ACME classes except for a semester of Volume 4 because I didn't do so well on the final and ended up with an A minus. I learned a _ton_ in this program.
- Don't compare yourself to others---_celebrate_ others!
  ...
  - Throughout the program, I often reflected on the third chapter of Malcolm Gladwell's _Outliers_. In it, Gladwell proposes that metrics for intellectual ability like test scores and IQ are only meaningful up to a threshold. Beyond a certain point, once someone is "smart enough", having an even higher score doesn’t make much of a difference---they are just as likely to succeed as those with the highest scores. While some people in ACME really stood out as bona fide geniuses, to me, everyone seemed to easily surpass the intelligence "threshold". There is no need to compare in ACME because if you've made it to the junior core, _you are smart enough_, and other attributes like emotional and interpersonal skills will probably have a much greater impact on your success than your raw intelligence.
